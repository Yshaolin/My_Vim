...
"	call <SID>X("pythonBuiltinObj", s:cyan, "", "")
	call <SID>X("pythonBuiltinFunc", s:cyan, "", "")
	call <SID>X("pythonBuiltinLogic", s:cyan, "", "")
    

	call <SID>X("pythonString", s:chartreuse, "", "")
	call <SID>X("pythonUniString", s:chartreuse, "", "")
	call <SID>X("pythonRawString", s:chartreuse, "", "")
	call <SID>X("pythonUniRawString", s:chartreuse, "", "")

	call <SID>X("pythonNumber", s:light_green, "", "none")
	call <SID>X("pythonHexNumber", s:light_green, "", "none")
	call <SID>X("pythonOctNumber", s:light_green, "", "none")
	call <SID>X("pythonBinNumber", s:light_green, "", "none")
	call <SID>X("pyhtonFloat", s:light_green, "", "none")
	...
	call <SID>X("pythonArithmetic", s:orange, "", "")
	call <SID>X("pythonCoding", s:orange, "", "")
	call <SID>X("pythonRun", s:orange, "", "")
	call <SID>X("pythonComparison", s:orange, "", "")
	call <SID>X("pythonAssignment", s:orange, "", "")
	call <SID>X("pythonFuncName", s:orange, "", "")
   


	call <SID>X("pythonFuncDef", s:blue, "", "")
	call <SID>X("pythonClassDef", s:blue, "", "")
	call <SID>X("pythonDecorator", s:blue, "", "")


	call <SID>X("pythonClassName", s:blue, "", "")
	call <SID>X("pythonSuperclass", s:yellow, "", "")
	call <SID>X("pythonParamDefault", s:yellow, "", "")
	call <SID>X("pythonParaName", s:yellow, "", "")
	call <SID>X("pythonStrFormatting", s:yellow, "", "")
	call <SID>X("pythonStrFormat", s:yellow, "", "")
	call <SID>X("pythonStrTemplate", s:yellow, "", "")
	call <SID>X("pythonFuncParams", s:yellow, "", "")
	call <SID>X("pythonParam", s:yellow, "", "")
	call <SID>X("pythonParamName", s:yellow, "", "")
	call <SID>X("pythonDefaultAssignment", s:yellow, "", "")
